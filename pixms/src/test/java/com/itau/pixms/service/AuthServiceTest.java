...
class AuthServiceTest {
    ...
    void setUp() throws Exception {
        ...
        when(pixConfig.getClientId()).thenReturn(CLIENT_ID);
        when(pixConfig.getClientSecret()).thenReturn(CLIENT_SECRET);
    }
    ...
    void shouldUseClientSecretFromConfiguration() {
        ...
        authService.getToken();
        verify(pixConfig).getClientSecret();
    }
}